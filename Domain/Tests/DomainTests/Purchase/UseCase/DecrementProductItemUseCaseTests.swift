//
//  DecrementProductItemUseCaseTests.swift
//  
//
...
final class DecrementProductItemUseCaseTests: XCTestCase {
    ...
    func testDecrementItem() {
        ...
        let useCase: DecrementProductItemUseCase = DecrementProductItemUseCaseImpl(
    ...
    func testTryDecrementItemWhenHasOnlyOne() {
        let purchase = Purchase(
            id: "Purchase_ID",
            items: [
                ProductItem(
