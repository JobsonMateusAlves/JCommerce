...
// MARK: Implementation
public class DecrementProductItemUseCaseImpl: DecrementProductItemUseCase {
    ...
    public func call(_ productItem: ProductItem, completion: @escaping (Result<Purchase, Error>) -> Void) {
